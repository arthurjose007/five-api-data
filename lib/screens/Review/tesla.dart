...
class TeslaReview extends StatefulWidget {
  const TeslaReview({super.key});

  @override
  State<TeslaReview> createState() => _TeslaReviewState();
}

class _TeslaReviewState extends State<TeslaReview> {
  Stream? TeslaStream;
  getloaded() async {
    TeslaStream = await DatabaseTesla().getemployeeDetails();
    setState(() {});
  }
