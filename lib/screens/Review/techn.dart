...
import 'package:apidata/auth/techne.dart';
...
class TechReview extends StatefulWidget {
  const TechReview({super.key});

  @override
  State<TechReview> createState() => _TechReviewState();
}

class _TechReviewState extends State<TechReview> {
  Stream? TechStream;
  getloaded() async {
    TechStream = await DatabaseTech().getemployeeDetails();
    setState(() {});
  }
