...
class AppleReview extends StatefulWidget {
  const AppleReview({super.key});

  @override
  State<AppleReview> createState() => _AppleReviewState();
}

class _AppleReviewState extends State<AppleReview> {
  ...
  getloaded() async {
    EmployeStream = await DatabaseApple().getemployeeDetails();
    setState(() {});
  }
